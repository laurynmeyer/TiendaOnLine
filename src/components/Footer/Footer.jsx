...
export const MyFooter = () => {
    return (
        <div className="footer-bg card-footer">
            <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top space_footer">
                ...
                <ul className="nav col-md-4 justify-content-end list-unstyled d-flex social_network">
